...
import com.picapp.picapp.utils.BitmapUtils;
import com.picapp.picapp.utils.SpacesItemDecoration;
...
public class FiltersListFragment extends Fragment implements ThumbnailsAdapter.ThumbnailsAdapterListener {
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (bitmap == null) {
                    thumbImage = BitmapUtils.getBitmapFromAssets(getActivity(), "an image", 100, 100);
                } else {
 ...
 //TODO: 8. Implementing the Main Interface (Combining the Fragment)
